...
- (void) viewDidAppear:(BOOL)animated {
    ...
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        ...
        [self.buttonCamera setTitle:NSLocalizedString(@"done", @"") forState:UIControlStateNormal];
        [self.buttonCamera srWhiteActionButtonStyle];
...
-(void)captureImage {
    ...
    [self.photoCaptureButton setTitle:NSLocalizedString(@"done", @"") forState:UIControlStateNormal];
